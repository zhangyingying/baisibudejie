//
//  ZYYVoiceLatestController.m
//  百思不得姐-张莹莹
//
//  Created by lanou3g on 14-10-4.
//  Copyright (c) 2014年 lanou3g. All rights reserved.
//

#import "ZYYVoiceLatestController.h"

@interface ZYYVoiceLatestController ()
...
@implementation ZYYVoiceLatestController
...
- (void)viewDidLoad
{
    ...
    [self voiceLatestAfhttpRequest];
}
- (void)voiceLatestAfhttpRequest{
    
    self.latestArray = [NSMutableArray array];
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    [manager GET:kVoiceLatestAPI parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
